$(document).ready(function() {
  // Getting references to the name and user container, as well as the table body
  ...
  function createUserRow(userData) {
    ...
    newTr.append("<td><a href='/landing.html'>Go to Posts</a></td>");
    newTr.append("<td><a href='/post.html'>Create a Post</a></td>");
